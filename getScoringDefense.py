...
def main(db, cursor):
    endpoints = ["28", "28/p2", "28/p3"]
    query = ("truncate scoringDefense")
    ...
    for endpoint in endpoints:
        ...
        for team in teams:
            ...
            while("" in teamToAdd):
                teamToAdd.remove("")
            if teamToAdd[0] == '-':
                add_record = ("INSERT INTO scoringdefense "
                "(ranking, team, games, tds, opppat, 2pt, oppdefpts, oppfg, oppsaf, pts, ppg) "
