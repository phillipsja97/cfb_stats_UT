...
def main(db, cursor):
    endpoints = ["756", "756/p2", "756/p3"]
    query = ("truncate completionpercentage")
    ...
    for endpoint in endpoints:
        ...
        for team in teams:
            ...
            while("" in teamToAdd):
                teamToAdd.remove("")
            if teamToAdd[0] == '-':
                add_record = ("INSERT INTO completionpercentage "
                "(ranking, team, games, completions, attempts, percentage) "
                "VALUES (%s, %s, %s, %s, %s, %s)")
